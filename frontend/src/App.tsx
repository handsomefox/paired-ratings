...
const RootLayout = () => {
  ...
  if (sessionQuery.isLoading) {
    return (
      <main className="mx-auto w-full max-w-[1920px] px-4 py-16 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <Loading />
      </main>
    );
  }
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto w-full max-w-[1920px] px-4 py-6 sm:px-6 md:py-8 lg:px-8 xl:px-10 2xl:px-12">
        <Outlet />
      </main>
