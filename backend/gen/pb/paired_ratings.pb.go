...
type Show struct {
	...
	CollectionId    *int64                 `protobuf:"varint,21,opt,name=collection_id,proto3,oneof" json:"collection_id,omitempty"`
	CollectionName  *string                `protobuf:"bytes,22,opt,name=collection_name,proto3,oneof" json:"collection_name,omitempty"`
	WatchedEpisodes *int32                 `protobuf:"varint,23,opt,name=watched_episodes,proto3,oneof" json:"watched_episodes,omitempty"`
	TotalEpisodes   *int32                 `protobuf:"varint,24,opt,name=total_episodes,proto3,oneof" json:"total_episodes,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Show) GetCollectionId() int64 {
...
func (x *Show) GetCollectionName() string {
...
func (x *Show) GetWatchedEpisodes() int32 {
	if x != nil && x.WatchedEpisodes != nil {
		return *x.WatchedEpisodes
	}
	return 0
}

func (x *Show) GetTotalEpisodes() int32 {
	if x != nil && x.TotalEpisodes != nil {
...
type RefreshResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Shows whose metadata was pulled again.
	Updated int32 `protobuf:"varint,1,opt,name=updated,proto3" json:"updated,omitempty"`
	// Shows that were stale but whose TMDB request failed. The refresh keeps
	// going past a failure, so both counts can be non-zero.
...
func (x *RefreshResponse) Reset() {
	*x = RefreshResponse{}
	mi := &file_paired_ratings_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RefreshResponse) Descriptor() ([]byte, []int) {
	return file_paired_ratings_proto_rawDescGZIP(), []int{21}
}
...
func (x *RefreshResponse) GetFailed() int32 {
	if x != nil {
		return x.Failed
	}
	return 0
...
type GetRelatedResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Results        []*SearchResult        `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	CollectionName *string                `protobuf:"bytes,2,opt,name=collection_name,proto3,oneof" json:"collection_name,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *GetRelatedResponse) Reset() {
	*x = GetRelatedResponse{}
	mi := &file_paired_ratings_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetRelatedResponse) Descriptor() ([]byte, []int) {
	return file_paired_ratings_proto_rawDescGZIP(), []int{22}
}

func (x *GetRelatedResponse) GetResults() []*SearchResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *GetRelatedResponse) GetCollectionName() string {
	if x != nil && x.CollectionName != nil {
		return *x.CollectionName
	}
	return ""
...
const file_paired_ratings_proto_rawDesc = "" +
	...
	"\x05error\x18\x01 \x01(\tR\x05error\"\xbb\b\n" +
	"\x04Show\x12\x0e\n" +
	...
	"\x0ewatch_priority\x18\x14 \x01(\x05H\vR\x0ewatch_priority\x88\x01\x01\x12)\n" +
	"\rcollection_id\x18\x15 \x01(\x03H\fR\rcollection_id\x88\x01\x01\x12-\n" +
	"\x0fcollection_name\x18\x16 \x01(\tH\rR\x0fcollection_name\x88\x01\x01\x12/\n" +
	"\x10watched_episodes\x18\x17 \x01(\x05H\x0eR\x10watched_episodes\x88\x01\x01\x12+\n" +
	"\x0etotal_episodes\x18\x18 \x01(\x05H\x0fR\x0etotal_episodes\x88\x01\x01B\a\n" +
	"\x05_yearB\t\n" +
	"\a_genresB\v\n" +
	"\t_overviewB\x0e\n" +
	"\f_poster_pathB\n" +
	...
	"\v_bf_commentB\r\n" +
	"\v_gf_commentB\x11\n" +
	"\x0f_watch_priorityB\x10\n" +
	"\x0e_collection_idB\x12\n" +
	"\x10_collection_nameB\x13\n" +
	"\x11_watched_episodesB\x11\n" +
	"\x0f_total_episodes\"f\n" +
	"\n" +
	"ShowDetail\x12*\n" +
	...
	"\x06failed\x18\x02 \x01(\x05R\x06failed\"\x91\x01\n" +
